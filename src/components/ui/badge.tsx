  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        critical: 'border-red-300 bg-red-50 text-red-700 font-semibold',
        ...
        info: 'border-blue-300 bg-blue-50 text-[#003366] font-semibold',
        saffron: 'border-amber-300 bg-amber-100 text-amber-900 font-semibold',
      },
    },
    defaultVariants: {
      variant: 'default',
